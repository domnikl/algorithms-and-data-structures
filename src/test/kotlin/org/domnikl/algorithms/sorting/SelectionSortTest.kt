...
class SelectionSortTest {
    ...
    fun `can sort integer arrays`() {
        ...
        Assert.assertArrayEquals(arrayOf(1, 3, 42), x.selectionSort())
    }
    ...
    fun `can sort arbitrary arrays`() {
        ...
        Assert.assertArrayEquals(arrayOf("bar", "foo"), x.selectionSort())
    }
    ...
    fun `can sort large collection`() {
        ...
        Assert.assertArrayEquals(items.toTypedArray(), shuffled.selectionSort())
    }
}